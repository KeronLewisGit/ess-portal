...
return [
    ...
    */
    ...
    'options' => [
         ...
         *
         * ESS: enabled. Without it dompdf embeds the entire DejaVu family in
         * every letter (~1.1 MB per one-page PDF); subsetting embeds only the
         * glyphs actually used. Letters are kept indefinitely, so this is the
         * difference between megabytes and kilobytes per issued document.
         */
         ...
         * @var bool
         *
         * ESS: disabled. Letter templates are HR-authored and rendered into
         * an official document — there is no reason for an issued letter to
         * carry executable JavaScript for the viewer.
         */
